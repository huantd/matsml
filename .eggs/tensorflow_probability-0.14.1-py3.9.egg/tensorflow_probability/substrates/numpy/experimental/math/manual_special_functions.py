...
from tensorflow_probability.substrates.numpy.internal import custom_gradient
...
#   `tensorflow_probability/substrates/numpy/experimental/math/manual_special_functions.py`
