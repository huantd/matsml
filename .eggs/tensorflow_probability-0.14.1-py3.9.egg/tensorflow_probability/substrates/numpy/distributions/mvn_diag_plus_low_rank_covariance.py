...
from tensorflow_probability.substrates.numpy.distributions import mvn_low_rank_update_linear_operator_covariance
...
#   `tensorflow_probability/substrates/numpy/distributions/mvn_diag_plus_low_rank_covariance.py`
