...
#   `tensorflow_probability/substrates/numpy/experimental/distributions/joint_density_coroutine.py`
...
from tensorflow_probability.substrates.numpy.experimental.distribute import joint_distribution as jdc_lib
