...
##### (3) TRAIN A MODEL #####
# data parameters
data_file = '/home/huantran/work/mol/data/df_2D_num_final_filtered_Tm_num_5K_molecules_RFFE-200.csv'
id_col = ['id_std']         
y_cols = ['New_Tm']    
...
# Model parameters
layers = [10,10,10]                    # list of nodes in hidden layers
epochs = 20                    # Epochs
...
model_params = {'algo':'nn tf','layers':layers,
        'activ_funct':activ_funct,'epochs':epochs,'nfold_cv':nfold_cv,
        'optimizer':optimizer,'use_bias':use_bias,'file_model':file_model,
        'loss':loss,'metric':metric,'batch_size':batch_size,
        'verbosity':verbosity,'rmse_cv':True}
